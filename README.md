...
3. Заходим в `Ultra Tuner` снова, он обновился и нам доступны новые пункты. Выбираем `Initialization Ultra`, и выбрав нужный нам стейдж, снова выходим назад, пару раз нажимая B.
